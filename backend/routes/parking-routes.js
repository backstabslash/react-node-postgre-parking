...
router.delete('/parkingslot/id/:id', ParkingSlotController.deleteParkingSlotByID);

router.patch('/parkingslot/id/:id', ParkingSlotController.patchParkingSlotStatusByID);
